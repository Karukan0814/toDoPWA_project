...
type Props = {
  todos: ToDo[];
  filter: Filter;
  handleOnTodo: <T extends ToDo, U extends keyof ToDo, V extends T[U]>(
    obj: T,
    key: U,
    value: V
  ) => void;
          ...
          <TodoCard key={todo.id}>
            <Form>
              <TextField
                ...
                value={todo.value}
                onChange={(e) =>
                  props.handleOnTodo(todo, "value", e.target.value)
                }
            ...
            <ButtonContainer>
              <Button
                onClick={() =>
                  props.handleOnTodo(todo, "checked", !todo.checked)
                }
              ...
              <Trash
                onClick={() =>
                  props.handleOnTodo(todo, "removed", !todo.removed)
                }
              >
                {todo.removed ? (
